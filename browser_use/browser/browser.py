...
class Browser:
	...
	async def _setup_standard_browser(self, playwright: Playwright) -> PlaywrightBrowser:
		"""Sets up and returns a Playwright Browser instance with anti-detection measures."""
		# user_data_dir="C:\\Users\\DilshadA\\AppData\\Local\\Google\\Chrome\\PlaywrightProfile"
        # # Remove old profile data if it exists
		# if os.path.exists(user_data_dir):
		# 	shutil.rmtree(user_data_dir)

		# # Create a fresh user profile directory
		...
		browser = await playwright.chromium.launch(
			...
			args=[
				...
				'--no-startup-window',
				'--window-position=0,0',
				'--disable-gpu',  # Helps prevent rendering issues
        		'--disable-dev-shm-usage',  # Useful for performance on Linux
